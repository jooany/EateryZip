...
public class MenuDto {
	...
	private int menu_num_in_section;
	...
	public MenuDto(int menu_num, String b_id, int section_num, int menu_num_in_section, String section_name,
		...
		this.menu_num_in_section = menu_num_in_section;
	...
	public int getMenu_num_in_section() {
		return menu_num_in_section;
	}

	public void setMenu_num_in_section(int menu_num_in_section) {
		this.menu_num_in_section = menu_num_in_section;
	}
