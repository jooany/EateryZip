...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
	<div id="container">
        ...
        <div class="content_search">
            <form action="${pageContext.request.contextPath}/eatery/list.do" class="serch_wrap" method="get"> <!-- 가게리스트로 연결 -->
                <div class="search_wrap">
                    <input type="text" class="search" placeholder="카테고리" value="${dto.b_kind }">
                    <input type="text" class="search" placeholder="지역" value="${dto.b_Store_Address }">
                </div>
                <button type="submit">
